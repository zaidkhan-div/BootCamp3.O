...
import Loinimg1 from "../../assets/images/login1.jpg"
import { LuTrendingUpDown } from "react-icons/lu"

const AuthLayout = ({ children }) => {
    return (
        <div className='flex'>
            <div className='w-screen h-screen md:w-[62vw] px-12 pt-8 pb-12'>
                <h2 className='text-lg font-medium text-black'>Expese Tracker</h2>
                {children}
            </div> 
            ...
            <div className="hidden md:block w-[40vw] h-screen bg-violet-50 bg-auth-bg-img bg-cover bg-no-repeat bg-center overflow-hidden p-8 relative ">
                ...
                <div className='w-48 h-56 rounded-[40px] border-violet-500 absolute -bottom-7 -right-10 -left-5'></div>
